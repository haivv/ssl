...
function saveContent() {
  const slideshow_img = quill.root.innerHTML;
  ...
  let slideshow_id = document.getElementById('slideshow_id').value;

  let formData = new URLSearchParams();
  formData.append('slideshow_img', slideshow_img);
  formData.append('slideshow_title', slideshow_title);
  formData.append('slideshow_summary', slideshow_summary);
  formData.append('slideshow_id', slideshow_id);
  // formData.append('txtfileupload', txtfileupload);

  fetch('/admin/slideshow-proUpdate', {
    method: 'POST',
    headers: {
