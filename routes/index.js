...
var sqlCat1 = "SELECT pro_id, pro_title FROM product where cat_id='1'";
var sqlCat2 = "SELECT pro_id, pro_title FROM product where cat_id='2'";
var sqlCat3 = "SELECT pro_id, pro_title FROM product where cat_id='3'";
var sqlCat4 = "SELECT pro_id, pro_title FROM product where cat_id='4'";
var sqlCat5 = "SELECT pro_id, pro_title FROM product where cat_id='5'";
							...
							if (error) {
								...
								database.query(sqlNews, function (error, dataNews) {
									if (error) {
										...
										res.render('publication/kr/index', { current_page, message, dataClient, dataNews, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5 });
									}
								});
							}
						});
...
router.post('/contactus-proAdd', (req, res) => {
	...
	database.query(sql, [txtname, txtemail, txtphone, txtcompany, txtsubject, txtmessage, dateString], function (error) {
		if (error) {
			...
			res.redirect('/?message=연락해주셔서 감사합니다#form-section');
		}
	});
}
else{
	res.redirect('/en/?message=연락해주셔서 감사합니다#form-section');
}
});
			...
			database.query(sqlCat3, function (error, dataCat3) {
				database.query(sqlCat4, function (error, dataCat4) {
					database.query(sqlCat5, function (error, dataCat5) {
						...
						res.render('publication/kr/aboutus', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5, dataAbout });
					});
					});
							...
							if (error) {
								...
								database.query(sqlpage, function (error, dataNews) {
									if (error) {
										...
										res.render('publication/kr/news', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5, dataNews, total_pages, page, total_records });
									}
								});
							}
						});
						...
						database.query(sql, function (error, dataNews) {
							if (error) {
								...
								res.render('error');
									...
									res.render('publication/kr/news-detail', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5, dataNews });
							...
							if (error) {
								...
								database.query(sqlpage, function (error, dataPatCer) {
									if (error) {
										...
										res.render('publication/kr/pat-cer', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5, dataPatCer, total_pages, page, total_records });
									}
								});
							}
						});
			...
			database.query(sqlCat3, function (error, dataCat3) {
				database.query(sqlCat4, function (error, dataCat4) {
					database.query(sqlCat5, function (error, dataCat5) {
						...
						res.render('publication/kr/partnership', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5 , dataQa, dataPatnership,dataPatnership_volvo});
					});
					});
					});
							...
							if (error) {
								...
								database.query(sqlpage, function (error, dataClient) {
									if (error) {
										...
										res.render('publication/kr/client', { current_page, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5, dataClient, total_pages, page, total_records });
									}
								});
							}
						});
			...
			database.query(sqlCat3, function (error, dataCat3) {
				database.query(sqlCat4, function (error, dataCat4) {
					database.query(sqlCat5, function (error, dataCat5) {
						...
						res.render('publication/kr/contact', { current_page,message, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5 });
								...
								var sql = `SELECT * FROM product WHERE pro_id= "${pro_id}"`;
									database.query(sql, function (error, dataProduct) {
										if (error) {
											...
											res.render('publication/kr/product', { title: 'Product View', current_page,message, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5,dataProduct });
										}
									});
	...
	database.query(sqlCat1, function (error, dataCat1) {
		database.query(sqlCat2, function (error, dataCat2) {
			database.query(sqlCat3, function (error, dataCat3) {
				database.query(sqlCat4, function (error, dataCat4) {
					database.query(sqlCat5, function (error, dataCat5) {
						res.render('publication/kr/privacy-policy', { 
	...
	database.query(sqlCat1, function (error, dataCat1) {
		database.query(sqlCat2, function (error, dataCat2) {
			database.query(sqlCat3, function (error, dataCat3) {
				database.query(sqlCat4, function (error, dataCat4) {
					database.query(sqlCat5, function (error, dataCat5) {
						res.render('publication/kr/term-of-service', { 
							current_page,message, dataCat1, dataCat2, dataCat3, dataCat4, dataCat5 
						});
					});
				});
